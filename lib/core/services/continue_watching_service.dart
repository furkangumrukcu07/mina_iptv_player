...
class ContinueWatchingService extends GetxService {
  ...
  void saveProgress({
    ...
    debugPrint('ContinueWatchingService: Saving progress - VOD ID: $vodId, Title: $title, Progress: ${progressPercent.toStringAsFixed(1)}%');
    
    // %95'ten fazla izlendiyse kaldır
    if (progressPercent > 95) {
      debugPrint('ContinueWatchingService: Removing completed VOD - ID: $vodId');
      removeItem(vodId);
      return;
    }
