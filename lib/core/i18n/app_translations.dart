...
const Map<String, String> _tr = {
  ...
  'marquee.monday': 'Haftaya enerjik bir başlangıç yapın! İyi haftalar dileriz.',
  'marquee.tuesday': 'Haftanın temposu artıyor, keyifli seyirler dileriz.',
  'marquee.wednesday': 'Haftanın ortasına geldik! En sevdiğiniz içeriklerle mola verin.',
  'marquee.thursday': 'Hafta sonuna az kaldı, Mina IPTV ile günün yorgunluğunu atın.',
  'marquee.friday': 'Mina İle Hafta sonu keyfi şimdiden başlasın.',
  'marquee.saturday': 'Hafta sonu eğlencesi burada! İyi istirahatler.',
  'marquee.sunday': 'Pazar keyfiniz bol olsun! Yeni haftaya hazırlanırken yanınızdayız.',
  ...
  'settings.speed_test.threshold.very_slow': 'Çok Yavaş - Donmalar ve takılmalar yaşayabilirsiniz',
  'settings.speed_test.threshold.borderline': 'Sınırda - HD yayınlarda anlık takılmalar olabilir',
  'settings.speed_test.threshold.excellent': 'Harika - Kesintisiz yayın izleyebilirsiniz',
  'settings.speed_test.message.very_slow': 'İnternet hızınız çok düşük. Donmalar yaşamanız normaldir. Lütfen ağınızı kontrol edin.',
  'settings.speed_test.message.borderline': 'İnternet hızınız sınırda. HD yayınlarda anlık takılmalar olabilir.',
  'settings.speed_test.message.excellent': 'İnternet hızınız harika. Kesintisiz yayın izleyebilirsiniz.',
...
const Map<String, String> _en = {
  ...
  'marquee.wednesday': 'We reached the middle of the week! Take a break with your favorite content.',
  'marquee.thursday': 'Almost weekend, relieve the day\'s fatigue with Mina IPTV.',
  'marquee.friday': 'Weekend fun starts now with Mina.',
  'marquee.saturday': 'Weekend entertainment is here! Have a good rest.',
  'marquee.sunday': 'Enjoy your Sunday! We are with you while preparing for the new week.',
  'home.header.brandTop': 'Mina',
  'home.header.brandBottom': 'IPTV Player',
  ...
  'settings.speed_test.threshold.very_slow': 'Very Slow - You may experience buffering and freezes',
  'settings.speed_test.threshold.borderline': 'Borderline - HD streams may have occasional stuttering',
  'settings.speed_test.threshold.excellent': 'Excellent - You can enjoy seamless streaming',
  'settings.speed_test.message.very_slow': 'Your internet speed is very low. Buffering is normal. Please check your network.',
  'settings.speed_test.message.borderline': 'Your internet speed is borderline. HD streams may have occasional stuttering.',
  'settings.speed_test.message.excellent': 'Your internet speed is excellent. You can enjoy seamless streaming.',
...
const Map<String, String> _jp = {
  'app.title': 'Japanese: Mina IPTV Player',
  'home.live': 'Japanese: Live TV',
  'home.live.subtitle': 'Japanese: Live broadcasts',
  'home.films': 'Japanese: Movies',
  'home.films.subtitle': 'Japanese: Movies & series',
  'home.series': 'Japanese: Series',
  'home.series.subtitle': 'Japanese: TV series',
  'home.favorites': 'Japanese: Favorites',
  'home.continue_watching': 'Japanese: Continue Watching',
  'marquee.monday': 'Japanese: Start the week with energy! Have a great week.',
  'marquee.tuesday': 'Japanese: The pace of the week is increasing, enjoy your viewing.',
  'marquee.wednesday': 'Japanese: We reached the middle of the week! Take a break with your favorite content.',
  'marquee.thursday': 'Japanese: Almost weekend, relieve the day\'s fatigue with Mina IPTV.',
  'marquee.friday': 'Japanese: Weekend fun starts now with Mina.',
  'marquee.saturday': 'Japanese: Weekend entertainment is here! Have a good rest.',
  'marquee.sunday': 'Japanese: Enjoy your Sunday! We are with you while preparing for the new week.',
  'home.header.brandTop': 'Japanese: Mina',
  'home.header.brandBottom': 'Japanese: IPTV Player',
  'home.search.hint': 'Japanese: Search…',
  'home.search.dialogTitle': 'Japanese: Search',
  'home.search.typeToSeeResults': 'Japanese: Type to see results.',
  'home.search.sectionLive': 'Japanese: Live TV',
  'home.search.sectionFilms': 'Japanese: Movies',
  'home.search.sectionSeries': 'Japanese: Series',
  'home.search.noResults': 'Japanese: No matching results.',
  'splash.preparing': 'Japanese: Preparing your library…',
  'integrity.dialog.title': 'Japanese: Use the official version',
  'integrity.dialog.body': 'Japanese: This install doesn’t match a Google Play license. For the safest experience, we recommend installing the app from Google Play.',
  'integrity.dialog.later': 'Japanese: Not now',
  'integrity.dialog.openPlay': 'Japanese: Open in Google Play',
  'browse.films': 'Japanese: Movies',
  'browse.series': 'Japanese: Series',
  'browse.favorites': 'Japanese: Favorites',
  'browse.empty': 'Japanese: No results found.',
  'browse.pickItem': 'Japanese: Select an item',
  'browse.tab.category': 'Japanese: Category',
  'browse.tab.detail': 'Japanese: Details',
  'browse.categoriesHeader': 'Japanese: Categories',
  'browse.seriesShort': 'Japanese: Series',
  'browse.season': 'Japanese: Season',
  'browse.episodes': 'Japanese: Episodes',
  'browse.seriesEpgButton': 'Japanese: Details',
  'browse.seriesEpgEmpty': 'Japanese: No detailed information for this series.',
  'browse.playFullscreen': 'Japanese: Play full screen',
  'browse.selectEpisode': 'Japanese: Select an episode',
  'browse.notPlayable': 'Japanese: Not playable',
  'browse.section.onNow': 'Japanese: On now',
  'browse.badge.live': 'Japanese: • Live',
  'browse.section.movie': 'Japanese: Movie',
  'browse.section.preview': 'Japanese: Preview',
  'browse.favorite': 'Japanese: Favorite',
  'browse.detail.epg': 'Japanese: No EPG feed is linked for this channel yet. When programme data is available, the title and summary will appear here.\n\nSelected: @title',
  'browse.detail.movie': 'Japanese: When the provider does not supply a synopsis, a short summary is shown here.\n\nDuration: @duration\nSelected: @name',
  'browse.duration.unknown': 'Japanese: Duration unknown',
  'browse.duration.minutes': 'Japanese: @n min',
  'browse.vod.trailer': 'Japanese: Trailer',
  'browse.vod.trailerMissing': 'Japanese: No trailer link for this title.',
  'browse.vod.overview': 'Japanese: Overview:',
  'browse.vod.shortInfo': 'Japanese: Film details',
  'browse.vod.metaLine.genre': 'Japanese: Genre: @v',
  'browse.vod.metaLine.director': 'Japanese: Director: @v',
  'browse.vod.metaLine.cast': 'Japanese: Cast: @v',
  'browse.vod.metaLine.release': 'Japanese: Released: @v',
  'browse.vod.metaLine.rating': 'Japanese: Rating: @v',
  'browse.vod.noSynopsis': 'Japanese: No synopsis from the source.',
  'browse.vod.trailerOpenFail': 'Japanese: Could not open the trailer.',
  'channels.search': 'Japanese: Search channels…',
  'channels.searchDialogTitle': 'Japanese: Search channels',
  'channels.searchSubmit': 'Japanese: Search',
  'channels.title': 'Japanese: Channels',
  'channels.empty': 'Japanese: No channels found.',
  'channels.pick': 'Japanese: Select a channel',
  'channels.tab.categories': 'Japanese: Categories',
  'channels.tab.channels': 'Japanese: Channels',
  'channels.tab.detail': 'Japanese: Details',
  'channels.tab.epgTimeline': 'Japanese: EPG',
  'channels.epgTimeline.title': 'Japanese: EPG timeline',
  'channels.epgTimeline.axis': 'Japanese: Time',
  'channels.epgTimeline.truncated': 'Japanese: Long list; showing only the first @n channels.',
  'channels.epgTimeline.upNext': 'Japanese: Up next',
  'channels.epgTimeline.noSummary': 'Japanese: No synopsis.',
  'channels.epgTimeline.playlistSource': 'Japanese: Playlist',
  'channels.epgTimeline.noProgrammeInfo': 'Japanese: No programme information',
  'channels.epgTimeline.minutesLeft': 'Japanese: @n min left',
  'channels.epgTimeline.endsUnderMinute': 'Japanese: Less than a minute left',
  'channels.epgTimeline.metaGroup': 'Japanese: Group: @name',
  'channels.allChannels': 'Japanese: All channels',
  'common.play': 'Japanese: Play',
  'common.notPlayable': 'Japanese: Not playable',
  'common.favorite': 'Japanese: Favorite',
  'common.back': 'Japanese: Back',
  'common.ok': 'Japanese: OK',
  'common.cancel': 'Japanese: Cancel',
  'common.close': 'Japanese: Close',
  'common.save': 'Japanese: Save',
  'common.delete': 'Japanese: Delete',
  'common.clear': 'Japanese: Clear',
  'common.active': 'Japanese: On',
  'common.inactive': 'Japanese: Off',
  'common.off': 'Japanese: Off',
  'common.loading': 'Japanese: Loading…',
  'common.yes': 'Japanese: Yes',
  'common.no': 'Japanese: No',
  'common.fetching': 'Japanese: Fetching…',
  'common.lang.tr': 'Japanese: Turkish',
  'common.lang.en': 'Japanese: English',
  'common.lang.fr': 'Japanese: French',
  'common.lang.ar': 'Japanese: Arabic',
  'common.lang.zh': 'Japanese: Chinese',
  'common.lang.ru': 'Japanese: Russian',
  'settings.speed_test.title': 'Japanese: Speed Test',
  'settings.speed_test.start': 'Japanese: Start Test',
  'settings.speed_test.testing': 'Japanese: Testing...',
  'settings.speed_test.completed': 'Japanese: Test Completed',
  'settings.speed_test.retry': 'Japanese: Retry',
  'settings.speed_test.download': 'Japanese: Download Speed',
  'settings.speed_test.last_result': 'Japanese: Last Test Result',
  'settings.speed_test.info.title': 'Japanese: Speed Limits',
  'settings.speed_test.threshold.very_slow': 'Japanese: Very Slow - You may experience buffering and freezes',
  'settings.speed_test.threshold.borderline': 'Japanese: Borderline - HD streams may have occasional stuttering',
  'settings.speed_test.threshold.excellent': 'Japanese: Excellent - You can enjoy seamless streaming',
  'settings.speed_test.message.very_slow': 'Japanese: Your internet speed is very low. Buffering is normal. Please check your network.',
  'settings.speed_test.message.borderline': 'Japanese: Your internet speed is borderline. HD streams may have occasional stuttering.',
  'settings.speed_test.message.excellent': 'Japanese: Your internet speed is excellent. You can enjoy seamless streaming.',
  'settings.speed_test.analysis.very_slow': 'Japanese: Very Low Speed',
  'settings.speed_test.analysis.borderline': 'Japanese: Borderline Speed',
  'settings.speed_test.analysis.excellent': 'Japanese: Excellent Speed',
  'settings.speed_test.error.title': 'Japanese: Error',
  'settings.speed_test.error.no_internet': 'Japanese: Please connect to the internet',
  'settings.speed_test.error.test_failed': 'Japanese: Test failed: @error',
  'settings.tile.speedTest': 'Japanese: Speed Test',
  'settings.tile.speedTest.sub': 'Japanese: Test your internet speed',
  'search.channel': 'Japanese: Search channels…',
  'search.film': 'Japanese: Search movies…',
  'search.series': 'Japanese: Search series…',
  'search.favorite': 'Japanese: Search favorites…',
  'layout.mobile': 'Japanese: Mobile',
  'layout.tablet': 'Japanese: Tablet',
  'layout.tv': 'Japanese: TV',
  'layout.mobile.sub': 'Japanese: Touch-friendly compact lists for phones.',
  'layout.tablet.sub': 'Japanese: Wider layout with medium text and spacing.',
  'layout.tv.sub': 'Japanese: Large text and focus for remotes and distance viewing.',
  'layout.dialog.phone.sub': 'Japanese: Portrait and landscape allowed',
  'layout.dialog.tv.sub': 'Japanese: Landscape lock (remote-focused)',
  'theme.defaultName': 'Japanese: Default',
  'theme.darkGlass': 'Japanese: Dark glass',
  'theme.glassmorphism': 'Japanese: Glassmorphism',
  'theme.darkFlat': 'Japanese: Dark Flat',
  'theme.glassGri': 'Japanese: Glass Gri',
  'theme.flatBlack': 'Japanese: Flat Black',
  'settings.title': 'Japanese: Settings',
  'settings.language': 'Japanese: App language',
  'settings.deviceMode': 'Japanese: Device mode',
  'settings.phone': 'Japanese: Phone',
  'settings.tv': 'Japanese: TV',
  'settings.blurReduce': 'Japanese: Reduce blur (performance)',
  'settings.blurReduce.subtitle': 'Japanese: Lower GPU use by reducing blur effects',
  'settings.launchOnBoot': 'Japanese: Launch on boot',
  'settings.launchOnBoot.subtitle': 'Japanese: Open the app after the device restarts',
  'settings.section.general': 'Japanese: General',
  'settings.section.about': 'Japanese: About',
  'settings.tile.playlist': 'Japanese: Playlist',
  'settings.tile.playlist.sub': 'Japanese: View or change your source',
  'settings.tile.refresh': 'Japanese: Refresh content',
  'settings.tile.refresh.loading': 'Japanese: Refreshing…',
  'settings.tile.refresh.sub': 'Japanese: Fetch the latest list from the server',
  'settings.tile.autoRefresh': 'Japanese: Auto refresh',
  'settings.tile.autoRefresh.sub': 'Japanese: Every @days days',
  'settings.tile.account': 'Japanese: Account info',
  'settings.tile.account.sub': 'Japanese: View Xtream subscription details',
  'settings.tile.parental': 'Japanese: Parental controls',
  'settings.tile.parental.sub': 'Japanese: PIN protection; hide Xtream categories (live, movies, series)',
  'settings.tile.xtreamApiEpgOnly': 'Japanese: Xtream API EPG only',
  'settings.tile.xtreamApiEpgOnly.on': 'Japanese: On: panel XMLTV skipped; get_all_live_epg only',
  'settings.tile.xtreamApiEpgOnly.off': 'Japanese: Off: panel XMLTV and API EPG together (parallel)',
  'settings.xtreamCategoryHide.title': 'Japanese: Hide categories',
  'settings.xtreamCategoryHide.unavailable': 'Japanese: Load a playlist first (Xtream or M3U).',
  'settings.xtreamCategoryHide.tabLive': 'Japanese: Live',
  'settings.xtreamCategoryHide.tabVod': 'Japanese: Movies',
  'settings.xtreamCategoryHide.tabSeries': 'Japanese: Series',
  'settings.xtreamCategoryHide.emptyLive': 'Japanese: No live categories.',
  'settings.xtreamCategoryHide.emptyVod': 'Japanese: No movie categories.',
  'settings.xtreamCategoryHide.emptySeries': 'Japanese: No series categories.',
  'settings.xtreamCategoryHide.idLabel': 'Japanese: ID: @id',
  'settings.xtreamCategoryHide.m3uNameHint': 'Japanese: M3U: by group-title name (persists after refresh)',
  'settings.xtreamCategoryHide.saved': 'Japanese: Category hiding saved.',
  'settings.tile.categoryHide': 'Japanese: Hide categories',
  'settings.tile.categoryHide.sub': 'Japanese: Hide categories for channels, movies and series',
  'settings.parental.title': 'Japanese: Parental controls',
  'settings.parental.createIntro': 'Japanese: Choose a 4–6 digit PIN. Category hiding opens with this PIN.',
  'settings.parental.verifyIntro': 'Japanese: Enter your PIN to open category settings.',
  'settings.parental.pinNew': 'Japanese: New PIN',
  'settings.parental.pinConfirm': 'Japanese: Confirm PIN',
  'settings.parental.pinEnter': 'Japanese: PIN',
  'settings.parental.savePin': 'Japanese: Save PIN',
  'settings.parental.unlock': 'Japanese: Continue',
  'settings.parental.pinInvalid': 'Japanese: PIN must be 4–6 digits.',
  'settings.parental.pinMismatch': 'Japanese: PINs do not match.',
  'settings.parental.pinWrong': 'Japanese: Incorrect PIN.',
  'settings.tile.sleepTimer': 'Japanese: Sleep timer',
  'settings.tile.clearAll': 'Japanese: Erase all settings',
  'settings.tile.clearAll.sub': 'Japanese: Reset playlist, cache, and preferences',
  'settings.tile.theme': 'Japanese: Theme',
  'settings.tile.subtitleOptions': 'Japanese: Subtitle options',
  'settings.tile.subtitleOptions.sub': 'Japanese: @pt pt',
  'settings.tile.layout': 'Japanese: Layout',
  'settings.tile.liveBuffer': 'Japanese: Low latency (buffer)',
  'settings.tile.liveBuffer.sub': 'Japanese: @n seconds',
  'settings.tile.adaptiveQuality': 'Japanese: HLS quality ceiling',
  'settings.dialog.adaptiveQualityTitle': 'Japanese: Multi-quality streams (HLS)',
  'settings.adaptiveQuality.optionAuto': 'Japanese: Automatic — based on screen size (recommended)',
  'settings.adaptiveQuality.option720': 'Japanese: Up to 720p',
  'settings.adaptiveQuality.option1080': 'Japanese: Up to 1080p',
  'settings.adaptiveQuality.option4k': 'Japanese: Up to 4K (2160p)',
  'settings.adaptiveQuality.shortAuto': 'Japanese: Automatic (device)',
  'settings.adaptiveQuality.short720': 'Japanese: Up to 720p',
  'settings.adaptiveQuality.short1080': 'Japanese: Up to 1080p',
  'settings.adaptiveQuality.short4k': 'Japanese: Up to 4K',
  'settings.tile.catchUpUrl': 'Japanese: EPG catch-up URL template',
  'settings.dialog.catchUpTitle': 'Japanese: Catch-up URL template',
  'settings.catchUp.optionOff': 'Japanese: Off',
  'settings.catchUp.optionXtreamPath': 'Japanese: Classic timeshift path (most Xtream)',
  'settings.catchUp.optionTimeshiftPhp': 'Japanese: timeshift.php query',
  'settings.catchUp.optionCustom': 'Japanese: Custom template',
  'settings.catchUp.shortOff': 'Japanese: Off',
  'settings.catchUp.shortXtreamPath': 'Japanese: /timeshift/…',
  'settings.catchUp.shortPhp': 'Japanese: timeshift.php',
  'settings.catchUp.shortCustom': 'Japanese: Custom',
  'settings.catchUp.customLabel': 'Japanese: Full URL line (placeholders in braces)',
  'settings.catchUp.customHint': 'Japanese: {server}/timeshift/{username}/…',
  'settings.catchUp.help': 'Japanese: Placeholders: {server} {username} {password} {stream_id} {duration} {start_utc_ymd_hms} {start_local_ymd_hms} {start_unix} {extension}. Match your provider.',
  'settings.tile.launchBoot': 'Japanese: Launch when device starts',
  'settings.tile.bgPlayback': 'Japanese: Background playback',
  'settings.tile.miniPlayerHome': 'Japanese: Mini player (PiP)',
  'settings.tile.miniPlayerHome.subTv': 'Japanese: Phone layout only',
  'settings.tile.miniPlayerHome.hintTv': 'Japanese: This option is for Android phone layout.',
  'settings.tile.miniPlayerHome.subOn': 'Japanese: On — return home for a draggable mini window (Better/Exo).',
  'settings.tile.miniPlayerHome.subOff': 'Japanese: Off — no PiP when leaving the player (Better/Exo, phone layout).',
  'settings.tile.miniPlayerHome.subMk': 'Japanese: Auto PiP is not available with MediaKit; use the default player.',
  'settings.tile.reduceBlur': 'Japanese: Reduce blur (speed)',
  'settings.tile.streamPreview': 'Japanese: Stream preview',
  'settings.tile.streamPreview.on': 'Japanese: Silent preview in list details (~after 1.8 s)',
  'settings.tile.streamPreview.off': 'Japanese: Off — no preview in live / movie / series lists',
  'settings.tile.streamPreview.tvLocked': 'Japanese: On TV you can turn this on or off in Settings',
  'settings.tile.defaultPlayer': 'Japanese: Default Player',
  'settings.tile.filmVodPlayer': 'Japanese: Movies / series player',
  'settings.tile.filmVodPlayer.subExo': 'Japanese: ExoPlayer (Better) — default; switches to MediaKit on decoder failure',
  'settings.tile.filmVodPlayer.subMediaKit': 'Japanese: MediaKit (mpv) — play directly with mpv',
  'settings.tile.useMediaKit': 'Japanese: Use MediaKit (mpv)',
  'settings.tile.useMediaKit.subOn': 'Japanese: On — movies & series use MediaKit; live TV always starts in Better Player',
  'settings.tile.useMediaKit.subOff': 'Japanese: Off — movies, series, and live use Better/Exo; MediaKit only as backup',
  'settings.tile.mediaKitHwdec': 'Japanese: Hardware acceleration (MediaKit)',
  'settings.tile.mediaKitHwdec.subBalanced': 'Japanese: Balanced — mediacodec-copy (recommended)',
  'settings.tile.mediaKitHwdec.subLowPower': 'Japanese: Low power / older TV box — mediacodec',
  'settings.tile.videoDecoder': 'Japanese: Video decoder (Android)',
  'settings.tile.about': 'Japanese: About',
  'settings.tile.about.loading': 'Japanese: Loading version…',
  'settings.tile.about.sub': 'Japanese: Mina IPTV Player @v',
  'settings.tile.help': 'Japanese: Help & support',
  'settings.tile.help.sub': 'Japanese: Report issues or get help',
  'settings.tile.privacy': 'Japanese: Privacy policy',
  'settings.tile.privacy.sub': 'Japanese: GitHub: furkangumrukcu07/mina_iptv_player',
  'settings.snackbar.privacy': 'Japanese: Privacy policy',
  'settings.snackbar.privacyFail': 'Japanese: Could not open the link.',
  'settings.snackbar.privacyManual': 'Japanese: Try opening in a browser:\nhttps://github.com/furkangumrukcu07/mina_iptv_player',
  'settings.snackbar.aboutTitle': 'Japanese: About',
  'settings.snackbar.aboutBody': 'Japanese: Mina IPTV Player',
  'settings.dialog.aboutFeatures': 'Japanese: Features\n'
      '• Live TV, movies, and series; M3U (URL/file) and Xtream playlists\n'
      '• Android TV, phone, and tablet layouts; multi-language UI\n'
      '• Search, categories, favorites; silent stream preview in details\n'
      '• Playback: live uses Better Player (Exo); VOD defaults to MediaKit (mpv, optional)\n'
      ...
      '• PiP (Better, phone), recording where supported; VOD audio/subtitles (Better)\n'
      '• Play: no READ_MEDIA gallery permissions; default theme is Default\n',
  'settings.dialog.sleepTimerTitle': 'Japanese: Sleep timer',
  'settings.sleepTimer.off': 'Japanese: Off',
  'settings.sleepTimer.optionMinutes': 'Japanese: @n minutes',
  'settings.sleepTimer.remaining': 'Japanese: About @min min left',
  'settings.sleepTimer.title': 'Japanese: Sleep timer',
  'settings.sleepTimer.fired': 'Japanese: Time is up; playback stopped and returned to home.',
  'settings.sleepTimer.set': 'Japanese: Sleep timer set for @n minutes.',
  'settings.sleepTimer.cleared': 'Japanese: Sleep timer turned off.',
  'settings.bufferSecondsZero': 'Japanese: 0 s',
  'settings.bufferSeconds': 'Japanese: @n s',
  'settings.decoder.software': 'Japanese: Software first — ExoPlayer (TS compatibility). MediaKit: libmpv auto-safe.',
  'settings.decoder.hardware': 'Japanese: Hardware first — ExoPlayer (default). MediaKit: libmpv auto-safe.',
  'settings.dialog.languageTitle': 'Japanese: App language',
  'settings.dialog.themeTitle': 'Japanese: Theme',
  'settings.dialog.subtitleTitle': 'Japanese: Subtitle size',
  'settings.dialog.subtitleHint': 'Japanese: Font size for embedded subtitles in ExoPlayer (Better Player) and MediaKit. Use the remote to move; Save is at the bottom.',
  'settings.dialog.subtitleChoice': 'Japanese: @pt pt',
  'settings.dialog.layoutTitle': 'Japanese: Device mode',
  'settings.dialog.refreshTitle': 'Japanese: Refresh content',
  'settings.dialog.refreshBody': 'Japanese: Content will refresh now. Do you also want to set how often to refresh automatically?',
  'settings.dialog.refresh.autoOff': 'Japanese: Auto refresh off',
  'settings.dialog.refresh.every3': 'Japanese: Refresh every 3 days',
  'settings.dialog.refresh.every7': 'Japanese: Refresh every week',
  'settings.dialog.refresh.nowOnly': 'Japanese: Refresh once now',
  'settings.dialog.clearTitle': 'Japanese: Erase all settings',
  'settings.dialog.clearBody': 'Japanese: Playlist data, cache, favorites, and preferences will be reset. Continue?',
  'settings.dialog.xmltvTitle': 'Japanese: XMLTV (EPG)',
  'settings.dialog.xmltv.hint': 'Japanese: https://…/epg.xml',
  'settings.dialog.xmltv.label': 'Japanese: EPG URL',
  'settings.dialog.bufferTitle': 'Japanese: Live stream buffer',
  'settings.dialog.bufferSlider': 'Japanese: @n seconds',
  'settings.dialog.changelogTitle': 'Japanese: Release notes',
  'settings.dialog.changelogBody': 'Japanese: v1.2.7\n'
      '• Playback: live TV uses Better Player; movies/series default to Exo (Better), optional MediaKit in Settings\n'
      '• MediaKit (Android): fixed VideoController init order (reduced VOD crash risk)\n'
      '• MediaKit: hardware decoder mode (Balanced / Low power), libmpv performance and buffer tuning\n'
      '• Settings: MediaKit and stream preview default ON; stay ON after “erase all settings”\n'
      ...
      'v1.0.5 — TV focus/scrolling; top-bar back removed\n'
      'v1.0.0 — Initial glass UI release\n',
  'settings.dialog.developerTitle': 'Japanese: Developer',
  'settings.dialog.developerBody': 'Japanese: Developer: furkangumrukcu',
  'settings.snackbar.content': 'Japanese: Content',
  'settings.snackbar.noPlaylist': 'Japanese: No saved playlist. Add one first.',
  'settings.snackbar.refreshOk': 'Japanese: Playlist updated successfully.',
  'settings.snackbar.error': 'Japanese: Error',
  'settings.snackbar.loadFailed': 'Japanese: Could not load: @e',
  'settings.snackbar.info': 'Japanese: Info',
  'settings.snackbar.xtreamOnly': 'Japanese: This feature is only for Xtream accounts.',
  'settings.snackbar.xtreamFail': 'Japanese: Could not load account info from the server.',
  'settings.snackbar.xtreamError': 'Japanese: Error while fetching info: @e',
  'settings.dialog.xtreamTitle': 'Japanese: Xtream account',
  'settings.xtream.user': 'Japanese: User:',
  'settings.xtream.status': 'Japanese: Status:',
  'settings.xtream.expiry': 'Japanese: Expires:',
  'settings.xtream.connections': 'Japanese: Active connections:',
  'settings.xtream.trial': 'Japanese: Trial account:',
  'settings.xtream.unlimited': 'Japanese: Unlimited',
  'settings.xtreamFooter.line': 'Japanese: Xtream: @user · @host',
  'settings.snackbar.settings': 'Japanese: Settings',
  'settings.snackbar.cleared': 'Japanese: All data cleared.',
  'settings.snackbar.clearFailed': 'Japanese: Could not clear: @e',
  'settings.snackbar.subtitles': 'Japanese: Subtitles',
  'settings.snackbar.subtitlesSoon': 'Japanese: Subtitle appearance options are coming soon.',
  'settings.snackbar.report': 'Japanese: Report issue',
  'settings.snackbar.reportFail': 'Japanese: Could not open email. Address: furkangumrukcu@gmail.com',
  'settings.snackbar.reportManual': 'Japanese: You can email furkangumrukcu@gmail.com',
  'settings.mail.subject': 'Japanese: Mina IPTV — Issue report',
  'settings.mail.body': 'Japanese: Device / version:\n\nDescribe the issue:\n',
  'playlist.title': 'Japanese: Playlist setup',
  'playlist.sourceTitle': 'Japanese: Choose source',
  'playlist.sourceSubtitle': 'Japanese: M3U URL, local file, or Xtream account.',
  'playlist.loadList': 'Japanese: Load playlist',
  'playlist.m3uUrl': 'Japanese: M3U URL',
  'playlist.m3uUrlHint': 'Japanese: https://example.com/playlist.m3u',
  'playlist.pickFile': 'Japanese: Choose file',
  'playlist.m3uXtreamRecommendation': 'Japanese: For better performance and features, we recommend signing in with Xtream.',
  'playlist.noFile': 'Japanese: No .m3u / .m3u8 file selected',
  'playlist.xtream.server': 'Japanese: Server URL',
  'playlist.xtream.serverPlaceholder': 'Japanese: Server URL (host)',
  'playlist.xtream.user': 'Japanese: Username',
  'playlist.xtream.pass': 'Japanese: Password',
  'playlist.xtream.hint': 'Japanese: You can paste URLs that include player_api.php directly.',
  'playlist.snackbar.file': 'Japanese: File',
  'playlist.snackbar.badExt': 'Japanese: Please choose a valid .m3u, .m3u8, or .txt file.',
  'playlist.snackbar.readFail': 'Japanese: Could not read file (no path or data)',
  'playlist.snackbar.fileError': 'Japanese: Error: @e',
  'playlist.snackbar.m3u': 'Japanese: M3U',
  'playlist.snackbar.setup': 'Japanese: Setup',
  'playlist.label.localM3u': 'Japanese: Local M3U',
  'playlist.error.emptyUrl': 'Japanese: M3U URL cannot be empty',
  'playlist.error.xtream': 'Japanese: Incomplete Xtream credentials',
  'playlist.merge.orphanCategory': 'Japanese: List 2',
  'playlist.secondaryTitle': 'Japanese: Second source (optional)',
  'playlist.secondarySubtitle': 'Japanese: A second M3U or Xtream adds live TV channels only; movies/series stay from the primary source.',
  'playlist.secondaryEnable': 'Japanese: Enable second playlist',
  'playlist.secondaryUrlHint': 'Japanese: Second M3U URL',
  'playlist.error.secondaryXtream': 'Japanese: Incomplete second Xtream credentials',
  'playlist.error.secondaryUrl': 'Japanese: Second M3U URL cannot be empty',
  'playlist.demoList': 'Japanese: Demo Playlist (Test)',
  'player.liveBadge': 'Japanese: LIVE',
  'player.epgLoading': 'Japanese: Loading EPG…',
};
