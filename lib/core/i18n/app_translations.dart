...
const Map<String, String> _tr = {
  ...
  'settings.tile.otherApps': 'Diğer Uygulamalarımız',
  'settings.tile.otherApps.sub': 'Windows ve Web uygulamalarımız',
  'settings.tile.windowsApp': 'Windows App İndir',
  'settings.tile.windowsApp.sub': 'Mina IPTV Player for Windows',
  'settings.tile.minatek': 'Minatek',
  'settings.tile.minatek.sub': 'minatek.com.tr',
  ...
  'settings.tile.railSettings': 'Rail Görünümü',
  'settings.tile.railSettings.sub': 'Sol menüde (railde) hangi sekmelerin görüneceğini seçin',
  'railSettings.title': 'Rail Görünümü',
  'railSettings.wrapper': 'Mina Wrapped',
  'railSettings.playlists': 'Listeler',
  'railSettings.repeat': 'Tekrar Karışık İzle',
  'railSettings.continueWatching': 'İzlemeye Devam Et',
  ...
  'settings.tile.performance': 'Performans',
  'performance.ram.used': 'Kullanılan RAM',
  'performance.ram.limit': 'Uygulama bellek limiti',
  'performance.ram.clean': 'RAM Bakımı',
  'performance.ram.clean.desc': 'Görsel önbelleğini boşaltır, çöp toplayıcıyı çalıştırır',
  'performance.action.run': 'Çalıştır',
  'performance.storage.clean': 'Bellek Temizleme',
  'performance.storage.calc': 'Hesaplanıyor...',
  'performance.storage.clean.desc': 'Kanal önbelleği + görsel disk önbelleği + geçici dosyalar • @n MB',
  'performance.action.clean': 'Temizle',
  'settings.performance.device': 'CİHAZ',
  'settings.performance.maintenance': 'BAKIM',
  'settings.performance.ramCleaned.title': 'RAM Temizlendi',
  'settings.performance.ramCleaned.desc': 'Görsel önbelleği boşaltıldı ve GC tetiklendi.',
  'settings.performance.storageCleaned.title': 'Bellek Temizlendi',
  'settings.performance.storageCleaned.desc': 'Disk üzerindeki geçici dosyalar silindi.',
  'settings.performance.cacheSettings': 'Önbellek Ayarları',
  'performance.image.cache.limit': 'Görsel Önbellek Sınırı',
  'performance.image.cache.limit.desc': 'RAM\'de tutulacak kanal logosu ve afiş görsellerinin limiti',
  'performance.storage.autoclean': 'Otomatik Temizleme Sıklığı',
  'performance.storage.autoclean.desc': 'Depolama önbelleğini belirli aralıklarla otomatik olarak temizler',
  'performance.cache.limit.auto': 'Otomatik (Cihaza göre)',
  'performance.cache.limit.low': 'Düşük (50 MB)',
  'performance.cache.limit.medium': 'Orta (150 MB)',
  'performance.cache.limit.high': 'Yüksek (300 MB)',
  'performance.cache.limit.max': 'Sınırsız / En Yüksek',
  'performance.cache.interval.off': 'Kapalı',
  'performance.cache.interval.everyLaunch': 'Her Açılışta',
  'performance.cache.interval.weekly': 'Haftalık',
  'performance.cache.interval.monthly': 'Aylık',
  ...
  'player.error.networkDisconnected': 'İnternet bağlantınız bulunmuyor',
  ...
  'exit.pressBackAgain': 'Çıkmak için tekrar geri tuşuna basın',
};
...
const Map<String, String> _en = {
  ...
  'settings.tile.otherApps': 'Our Other Apps',
  'settings.tile.otherApps.sub': 'Windows and Web applications',
  'settings.tile.windowsApp': 'Download Windows App',
  'settings.tile.windowsApp.sub': 'Mina IPTV Player for Windows',
  'settings.tile.minatek': 'Minatek',
  'settings.tile.minatek.sub': 'minatek.com.tr',
  ...
  'settings.tile.railSettings': 'Rail View',
  'settings.tile.railSettings.sub': 'Choose which tabs appear on the left menu (rail)',
  'railSettings.title': 'Rail View',
  'railSettings.wrapper': 'Mina Wrapped',
  'railSettings.playlists': 'Playlists',
  'railSettings.repeat': 'Repeat Mix',
  'railSettings.continueWatching': 'Continue Watching',
  ...
  'settings.tile.performance': 'Performance',
  'performance.ram.used': 'Used RAM',
  'performance.ram.limit': 'App memory limit',
  'performance.ram.clean': 'RAM Maintenance',
  'performance.ram.clean.desc': 'Clears image cache, runs garbage collector',
  'performance.action.run': 'Run',
  'performance.storage.clean': 'Storage Cleaning',
  'performance.storage.calc': 'Calculating...',
  'performance.storage.clean.desc': 'Channel cache + image disk cache + temp files • @n MB',
  'performance.action.clean': 'Clean',
  'settings.performance.device': 'DEVICE',
  'settings.performance.maintenance': 'MAINTENANCE',
  'settings.performance.ramCleaned.title': 'RAM Cleaned',
  'settings.performance.ramCleaned.desc': 'Image cache cleared and GC triggered.',
  'settings.performance.storageCleaned.title': 'Storage Cleaned',
  'settings.performance.storageCleaned.desc': 'Temporary files on disk have been deleted.',
  'settings.performance.cacheSettings': 'Cache Settings',
  'performance.image.cache.limit': 'Image Cache Limit',
  'performance.image.cache.limit.desc': 'Max memory limit for channel logos and poster images in RAM',
  'performance.storage.autoclean': 'Auto-Clean Cache Interval',
  'performance.storage.autoclean.desc': 'Automatically clears temporary storage cache at set intervals',
  'performance.cache.limit.auto': 'Auto (Based on device)',
  'performance.cache.limit.low': 'Low (50 MB)',
  'performance.cache.limit.medium': 'Medium (150 MB)',
  'performance.cache.limit.high': 'High (300 MB)',
  'performance.cache.limit.max': 'Unlimited / Max',
  'performance.cache.interval.off': 'Off',
  'performance.cache.interval.everyLaunch': 'Every Launch',
  'performance.cache.interval.weekly': 'Weekly',
  'performance.cache.interval.monthly': 'Monthly',
  ...
  'player.error.networkDisconnected': 'No internet connection',
  ...
  'exit.pressBackAgain': 'Press back button again to exit',
};
