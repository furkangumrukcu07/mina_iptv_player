                ...
                return Stack(
                  children: [
                    ...
                    Obx(() {
                      ...
                      final chans =
                          controller.liveChannelStripChannelsForOverlay();
                      if (chans.isEmpty) {
                        return const SizedBox.shrink();
                      }
                      final catTabs =
                          controller.liveChannelStripShowsCategoryTabs;
                      ...
                      return LiveChannelStripOverlay(
                        ...
                        channels: List<Channel>.from(chans),
                        ...
                        onCategoryPrevious: catTabs
                            ? () => controller.shiftLiveStripCategory(-1)
                            : null,
                        onCategoryNext: catTabs
                            ? () => controller.shiftLiveStripCategory(1)
                            : null,
                        categoryChipLabels:
                            chipNames.isNotEmpty ? chipNames : null,
                    ...
                    Obx(() {
                      ...
                      return PlayerLiveEpgOverlayShell(
                        channel: controller.channel.value,
                        onClose: () =>
                            controller.closeLiveSingleChannelEpgOverlay(
                          showOsdAfter: true,
                        ),
                        onHardwareBack: () {
                          _consumeNextSystemBackPop = true;
                    ...
                    Obx(() {
                      ...
                      final chipNames =
                          controller.vodBrowseRailCategoryTabNames;
                      final chipIdx = chipNames.isEmpty
                          ? 0
                          : controller.vodBrowseRailCategoryIndex.value
                              .clamp(0, chipNames.length - 1);
                      final mv = controller.vodBrowseRailMovies;
                      if (mv != null && mv.isNotEmpty) {
                        final catTabs =
                            controller.vodBrowseRailShowsCategoryTabs;
                        return VodBrowseRailOverlay(
                          isMovieMode: true,
                          movies: List<Channel>.from(mv),
                          ...
                          categoryShortcutEnabled: catTabs,
                          onCategoryPrevious: catTabs
                              ? () => controller.shiftVodBrowseRailCategory(-1)
                              : null,
                          onCategoryNext: catTabs
                              ? () => controller.shiftVodBrowseRailCategory(1)
                              : null,
                      ...
                      final sv = controller.vodBrowseRailSeriesItems;
                      if (sv != null && sv.isNotEmpty) {
                        ...
                        return VodBrowseRailOverlay(
                          ...
                          series: List<SeriesItem>.from(sv),
                          currentMovieId: controller.channel.value.id,
