...
class HlsMediaPlaylist extends HlsPlaylist {
  ...
  factory HlsMediaPlaylist.create({
    ...
    final int? effectiveStartOffsetUs;
    if (startOffsetUs != null && startOffsetUs < 0) {
      effectiveStartOffsetUs = (durationUs ?? 0) + startOffsetUs;
    } else {
      effectiveStartOffsetUs = startOffsetUs;
    }

    return HlsMediaPlaylist._(
      playlistType: playlistType,
      startOffsetUs: effectiveStartOffsetUs,
